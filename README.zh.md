...
<p align="center">
  ...
  <a href="https://img.shields.io/github/languages/code-size/qyfanshen/canyin.qyfanshen"><img src="https://img.shields.io/github/languages/code-size/qyfanshen/canyin.qyfanshen" alt="代码体积"></a>
...
**智餐云** 是面向连锁餐饮与中小餐厅的轻量级数字化管理平台——订单、会员、营收与角色权限一站式管理，可在任意静态托管快速部署。

[English](README.md) | [中文](README.zh.md)

## 核心使用场景

- **🏪 连锁门店运营** — 多门店、会员、营收与订单集中管理，一个看板掌握全局。
- **📊 数据驱动决策** — 实时查看日营收、订单量、翻台率，辅助经营决策。
- **👥 分角色访问** — 管理端 / 门店员工 / 后勤端各司其职，按角色展示对应功能。
...
- 隐私与法律页面：privacy.html + PRIVACY.md
- MIT 协议，易于 fork 与品牌化
- 首屏渲染快、带宽占用低
...
- 站点域名：https://canyin.qyfanshen.com
